...
A Taxa de Poupança Pessoal (TPS), do inglês *Personal Savings Rate*, mede a porcentagem da renda líquida mensal que é efetivamente poupada após o pagamento de todas as despesas. Trata-se de um indicador crucial para avaliar a capacidade de um indivíduo em acumular patrimônio, preparar-se para emergências e alcançar objetivos financeiros de longo prazo. Autores como Gitman (2012) \cite{gitman2012} enfatizam a importância da poupança regular como um dos pilares da administração financeira pessoal.

\textbf{Cálculo:}
$$
\text{TPS} = \left(\frac{\text{Renda Líquida Mensal} - \text{Despesas Totais Mensais}}{\text{Renda Líquida Mensal}}\right) \times 100
$$
Alternativamente, pode ser expressa como:
$$
\text{TPS} = \left(\frac{\text{Poupança Mensal}}{\text{Renda Líquida Mensal}}\right) \times 100
$$

\textbf{Interpretação:}  

Uma TPS mais elevada geralmente indica uma melhor saúde financeira e maior disciplina nos gastos, resultando em maior capacidade de investimento e realização de metas. Segundo Gitman e Zutter (2012)\cite{gitman2012}, a formação de poupança regular é considerada um dos pilares da administração financeira pessoal. Além disso, estudos de planejamento financeiro pessoal, como os de Lusardi (2019)\cite{lusardi2019}, destacam que valores inferiores a 10\% da renda líquida costumam estar associados a maior vulnerabilidade em situações de emergência.  
De forma prática, diversos especialistas recomendam que a taxa de poupança pessoal seja mantida, no mínimo, entre 10\% e 15\% da renda líquida \cite{gitman2012, lusardi2019}. Valores consistentemente abaixo desse patamar podem sinalizar a necessidade de uma revisão orçamentária, seja para identificar despesas que possam ser reduzidas ou para buscar alternativas de incremento de renda.


\subsection{Razão Dívida-Renda (RDR)}
A Razão Dívida-Renda (RDR), conhecida internacionalmente como *Debt-to-Income Ratio* (DTI), é uma métrica financeira pessoal que compara o montante total dos pagamentos mensais de dívidas de um indivíduo com sua renda bruta mensal. Este indicador é amplamente utilizado por instituições financeiras e credores para avaliar a capacidade de um indivíduo de gerenciar seus pagamentos mensais e, consequentemente, sua capacidade de assumir novas dívidas de forma sustentável \cite{gitman2012, cfpb_dti}.

\textbf{Cálculo:}
$$
\text{RDR} = \left(\frac{\text{Soma dos Pagamentos Mensais de Todas as Dívidas}}{\text{Renda Bruta Mensal}}\right) \times 100
$$
Onde a "Soma dos Pagamentos Mensais de Todas as Dívidas" inclui parcelas de empréstimos, financiamentos (imobiliário, veículo), pagamentos mínimos de cartões de crédito, e outras obrigações financeiras regulares. A "Renda Bruta Mensal" refere-se ao total de rendimentos antes de impostos e outras deduções.
...
\begin{itemize}
    \item \textbf{Renda Bruta Mensal}: R\$ 5.000,00 \\
    Valor total que João recebe antes de impostos e descontos obrigatórios.
    
    \item \textbf{Renda Líquida Mensal}: R\$ 4.200,00 \\
    Valor efetivamente disponível após deduções, ou seja, o dinheiro que entra na conta.
    ...
    \item \textbf{Demais Despesas Fixas e Variáveis}: R\$ 1.700,00, incluindo:
    \begin{itemize}
    ...
    \item \textbf{Despesas Totais Mensais}: \\
    Pagamentos de dívidas (R\$ 2.100,00) + demais despesas (R\$ 1.700,00) = \textbf{R\$ 3.800,00}
\end{itemize}

\noindent
\textbf{1. Cálculo da Razão Dívida-Renda (RDR):}
\[
\text{RDR} = \frac{2.100}{5.000} \times 100 = 42\%
\]
Isso significa que 42\% da \textbf{renda bruta} de João está comprometida apenas com dívidas.

\noindent
\textbf{2. Cálculo da Taxa de Poupança Pessoal (TPS):}
\[
\text{TPS} = \frac{4.200 - 3.800}{4.200} \times 100
\]
\[
\text{TPS} = \frac{400}{4.200} \times 100 \approx 9,52\%
\]
Ou seja, João consegue poupar apenas 9,5\% de sua \textbf{renda líquida}, abaixo do mínimo recomendado (10--15\%).

\noindent
\textbf{3. Interpretação do Perfil:}
\begin{itemize}
    \item \textbf{Endividamento}: A RDR de 42\% mostra que João dedica quase metade de sua renda bruta ao pagamento de dívidas.
    \item \textbf{Poupança}: Sua TPS de 9,5\% indica baixa capacidade de formar reserva financeira.
    \item \textbf{Síntese}: Perfil de atenção – alto comprometimento com dívidas e pouca poupança.
\end{itemize}
