...
urlpatterns = [
    ...
    path("admin-panel/missoes/excluir-pendentes/", AdminDeletePendingMissionsView.as_view(), name="admin-delete-pending-missions"),
    path("admin-panel/missoes/aprovar-pendentes/", AdminApprovePendingMissionsView.as_view(), name="admin-approve-pending-missions"),
